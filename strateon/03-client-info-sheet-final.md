...
> Финальный английский текст без внутренних примечаний (PDF: `STRATEON_Client_Information_Sheet_v2.pdf`, **4 страницы** включая обложку (просторная вёрстка с увеличенным межстрочным интервалом; стр. 4 — блок подписи)). По решению владельца удалены: антикоррупционный абзац, весь раздел Compliance Statement (включая UBO/санкционную/PEP-декларации и комплаенс-контакт) и абзац-обязательство о неведении нефтяных видов деятельности. Разделы с недостающими данными (TRN, VAT, аудитор, банк, география, опыт) не включены — заготовки в [02-client-info-sheet-revised.md](02-client-info-sheet-revised.md). Сканы паспорта и Emirates ID передаются отдельно по запросу (раздел 07). Таблицы — с полными рамками.
...
## 03. Management and Authorised Signatory

| | |
|---|---|
| Name / Position | Vladislav Kashin — Director (First Manager per Trade Licence); nationality: Russian (Russian Federation) |
